...
import { Alert, reviewSubmitHandler } from "./Action";
...
const ReviewForm = (props) => {
  ...
  if (formData.error || formData.success) {
    setTimeout(() => {
      setFormData({ ...formData, error: false, success: false });
    }, 3000);
  }
      ...
      {ratingUserList.includes(isAuthenticate().user._id) ? (
        ...
        <div className="mb-12 md:mx-16 lg:mx-20 xl:mx-24 flex flex-col">
          ...
          <div className="space-y-4">
            ...
            <div
              onClick={(e) => reviewSubmitHandler(formData, setFormData, fetchData)}

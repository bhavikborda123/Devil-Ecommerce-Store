        ...
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left cursor-pointer px-2"
            >
              <img
                src={logo}
                style={{ maxHeight: "45px", height: "auto" }}
                alt="devil store logo"
          ...
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 tracking-widest"
          >
            <img
              src={logo}
              style={{ maxHeight: "45px", height: "auto" }}
                    ...
                    {!isAdmin() ? (
                      <Fragment>
                        <li className="flex flex-col text-gray-700 w-48 shadow-lg">
                          ...
                          <span
                            onClick={(e) => history.push("/user/wishlist")}
                            className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer"
                            title="Wishlist"
                          >
                            <span>
